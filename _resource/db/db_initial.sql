...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'NTL',   0, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '总公司', 1, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '分公司', 2, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'NTL', '15888888888', 'ntl@test.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'suadmin', 'NTL', '00', 'ntl@163.com', '15888888888', '1', '', '161738380423591bc5989be09449832d', '123321', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'suadmin', sysdate(), '', null, 'super管理员');
insert into sys_user values(2,  105, 'admin',    'NTL', '00', 'ntl@test.com',  '15666666666', '1', '', '0cc12d6488b475eba65a4b7336002cf0', 'a73852', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_post values(2, 'manager',   '项目经理',  2, '0', 'admin', sysdate(), '', null, '');
...
-- 初始化-角色信息表数据
-- ----------------------------
insert into sys_role values('1', '超级管理员', 'superadmin',  1, 1, '0', '0', 'suadmin', sysdate(), '', null, '超级管理员');
insert into sys_role values('2', '管理员角色',   'admin', 2, 2, '0', '0', 'suadmin', sysdate(), '', null, '管理员角色');
...
insert into sys_menu values('105',  '字典管理', '1', '6', '#',                     '', 'M', '0', '1', '',                         'fa fa-database',        'admin', sysdate(), '', null, '字典管理菜单');
...
insert into sys_menu values('503',  '错误日志', '108', '3', '/monitor/sysErrorLog', '', 'C', '0', '1', 'monitor:sysErrorLog:view',  'fa fa-file-image-o',    'admin', sysdate(), '', null, '错误日志菜单');


insert into sys_menu values('510', '系统字典', '105', '1', '/system/dict', 'menuItem', 'C', '0', '1', 'system:dict:view', 'fa fa-bookmark-o', 'admin', '2023-06-23 18:42:59', 'admin', '2023-06-23 19:05:28', '字典管理菜单');
insert into sys_menu values('511', '业务字典', '105', '2', '/system/dict/business/common', 'menuItem', 'C', '0', '1', 'system:businessCommonDict:view', 'fa fa-book', 'admin', '2023-06-23 19:13:16', '', NULL, '');
insert into sys_menu values('512', '自定义字典', '105', '3', '/system/dict/business/user', 'menuItem', 'C', '0', '1', 'system:businessUserDict:view', 'fa fa-book', 'admin', '2023-06-23 19:05:17', 'admin', '2023-06-23 19:13:29', '');
...
-- 系统字典功能 按钮
insert into sys_menu values('1025', '字典查询', '510', '1',  '#', '',  'F', '0', '1', 'system:dict:list',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1026', '字典新增', '510', '2',  '#', '',  'F', '0', '1', 'system:dict:add',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1027', '字典修改', '510', '3',  '#', '',  'F', '0', '1', 'system:dict:edit',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1028', '字典删除', '510', '4',  '#', '',  'F', '0', '1', 'system:dict:remove',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1029', '字典导出', '510', '5',  '#', '',  'F', '0', '1', 'system:dict:export',      '#', 'admin', sysdate(), '', null, '');
...
-- 业务字典功能 按钮
insert into sys_menu values('1062', '列表', '511', '1', '#', 'menuItem', 'F', '0', '1', 'system:businessCommonDict:list', '#', 'admin', '2023-06-23 19:13:53', '', NULL, '');
insert into sys_menu values('1063', '增加', '511', '2', '#', 'menuItem', 'F', '0', '1', 'system:businessCommonDict:add', '#', 'admin', '2023-06-23 19:14:12', '', NULL, '');
insert into sys_menu values('1064', '修改', '511', '3', '#', 'menuItem', 'F', '0', '1', 'system:businessCommonDict:edit', '#', 'admin', '2023-06-23 19:14:38', '', NULL, '');
insert into sys_menu values('1065', '删除', '511', '4', '#', 'menuItem', 'F', '0', '1', 'system:businessCommonDict:remove', '#', 'admin', '2023-06-23 19:15:01', 'admin', '2023-06-23 22:14:19', '');
insert into sys_menu values('1066', '导出', '511', '5', '#', 'menuItem', 'F', '0', '1', 'system:businessCommonDict:export', '#', 'admin', '2023-06-23 22:14:49', '', NULL, '');
-- 自定义字典功能 按钮
insert into sys_menu values('1067', '列表', '512', '1', '#', 'menuItem', 'F', '0', '1', 'system:businessUserDict:list', '#', 'admin', '2023-06-23 19:06:55', '', NULL, '');
insert into sys_menu values('1068', '添加', '512', '2', '#', 'menuItem', 'F', '0', '1', 'system:businessUserDict:add', '#', 'admin', '2023-06-23 19:07:13', 'admin', '2023-06-23 19:08:07', '');
insert into sys_menu values('1069', '修改', '512', '3', '#', 'menuItem', 'F', '0', '1', 'system:businessUserDict:edit', '#', 'admin', '2023-06-23 19:07:44', 'admin', '2023-06-23 19:08:19', '');
insert into sys_menu values('1070', '删除', '512', '4', '#', 'menuItem', 'F', '0', '1', 'system:businessUserDict:remove', '#', 'admin', '2023-06-23 19:08:50', '', NULL, '');
insert into sys_menu values('1071', '导出', '512', '5', '#', 'menuItem', 'F', '0', '1', 'system:businessUserDict:export', '#', 'admin', '2023-06-23 22:17:03', '', NULL, '');
-- 错误日志功能 按钮
insert into sys_menu values('1072', '列表', '503', '1', '#', 'menuItem', 'F', '0', '1', 'monitor:sysErrorLog:list', '#', 'admin', '2023-06-23 19:06:55', '', NULL, '');
...
(
  ...
  dict_type        varchar(100)    default ''                 comment '字典类型key',
  status           char(1)         default '0'                comment '状态（0正常 1停用）',
  type             char(1)         default '0'                comment '类型(0系统字典，1业务字典，2自定义字典)',
  create_by        varchar(64)     default ''                 comment '创建者',
  create_time      datetime                                   comment '创建时间',
  update_by        varchar(64)     default ''                 comment '更新者',
  update_time      datetime                                   comment '更新时间',
...
insert into sys_dict_type values(11, '阅读状态', 'sys_read_status',     '0', '0', 'admin', sysdate(), '', null, '阅读状态列表');
...
insert into sys_dict_data values(30, 1,  '未读',     '0',       'sys_read_status',   '',   'warning', 'N', '0', 'admin', sysdate(), '', null, '未读状态');
insert into sys_dict_data values(31, 2,  '已读',     '1',       'sys_read_statusww',   '',   'primary', 'N', '0', 'admin', sysdate(), '', null, '已读状态');
...
insert into sys_job values(1, '系统默认（无参）', 'DEFAULT', 'webcoreTask.jobNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'webcoreTask.jobParams(\'ntl\')',  '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'webcoreTask.ryMultipleParams(\'ntl\', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 NTL新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 NTL系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
...
-- --------------------------------------------------------------
-- SYS_ERROR_LOG: 21.错误日志表
-- --------------------------------------------------------------
DROP TABLE IF EXISTS SYS_ERROR_LOG;
CREATE TABLE SYS_ERROR_LOG(
    id                       varchar(32)                                                                          comment '主键ID',
    error_code               varchar(100)             not null                                                    comment '错误代码',
    error_type               varchar(200)                                                                         comment '异常类型',
    error_message            longtext                                                                             comment '错误日志',
    status                   char(1)                                           default '0'                        comment '阅读状态（0=未读&1=已读）',
    request_ip               varchar(64)                                                                          comment 'requestIP',
    server_ip                varchar(64)                                                                          comment '异常服务器IP',
    service_id               varchar(100)                                                                         comment '异常服务器服务ID',
    operator                 varchar(32)                                                                          comment '操作人',
    log_time                 datetime                                         default CURRENT_TIMESTAMP           comment '日志时间',
    remark                   varchar(500)                                                                         comment '备注',
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='21.错误日志表';
