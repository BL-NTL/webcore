package com.ntl.webcore.common.lang.string;

import com.ntl.webcore.common.lang.constant.Constants;
import com.ntl.webcore.common.lang.text.StrFormatter;
...
public class StrUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    {
        return StrUtils.startsWithAny(link, Constants.HTTP, Constants.HTTPS);
    }
    ...
    {
        if (!StrUtils.isEmpty(str) && str.endsWith(spit))
        {
     ...
     * @return
     */
    public static String subByte(String source,int length){
        String result = null;
        int sourceLength = source == null ? 0 : source.getBytes().length;
        if(sourceLength > length){
            byte[] temp = new byte[length];

            System.arraycopy(source.getBytes(),0,temp,0,length);
