package com.ntl.webcore.common.web.model;
...
public class AjaxResult extends HashMap<String, Object>
{
    ...
    public static AjaxResult error(BaseErrorCode errorCode){
        return AjaxResult.error("错误代码" + errorCode.getErrorCode() +", 请联系管理员！");
    }
