package com.ntl.webcore.generator.controller;
...
import com.ntl.webcore.generator.service.IGenTableColumnService;
import com.ntl.webcore.generator.service.IGenTableService;
import com.ntl.webcore.system.common.model.view.CxSelect;
...
public class GenController extends BaseController
{
    ...
    public String edit(@PathVariable("tableId") Long tableId, ModelMap mmap)
    {
        ...
        {
            if (!StrUtils.equals(table.getTableName(), genTable.getTableName()))
            {
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"webcore.zip\"");
