...
public class JobInvokeUtil
{
    ...
    public static List<Object[]> getMethodParams(String invokeTarget)
    {
        ...
        for (int i = 0; i < methodParams.length; i++)
        {
            ...
            // String字符串类型，以'或"开头
            if (StrUtils.startsWithAny(str, "'", "\""))
            {
                classs.add(new Object[] { StrUtils.substring(str, 1, str.length() - 1), String.class });
            }
            ...
            // long长整形，以L结尾
            else if (StrUtils.endsWith(str, "L"))
            {
                classs.add(new Object[] { Long.valueOf(StrUtils.substring(str, 0, str.length() - 1)), Long.class });
            }
            // double浮点类型，以D结尾
            else if (StrUtils.endsWith(str, "D"))
            {
                classs.add(new Object[] { Double.valueOf(StrUtils.substring(str, 0, str.length() - 1)), Double.class });
            }
            // 其他类型归类为整形
            else
            {
