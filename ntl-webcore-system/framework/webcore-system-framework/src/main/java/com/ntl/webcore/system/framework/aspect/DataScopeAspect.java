...
import com.ntl.webcore.framework.datasource.annotation.DataScope;
import com.ntl.webcore.framework.web.context.PermissionContextHolder;
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            else if (DATA_SCOPE_SELF.equals(dataScope))
            {
                ...
                else
                {
                    ...
                    sqlString.append(StrUtils.format(" OR {}.dept_id = 0 ", deptAlias));
                }
            }
