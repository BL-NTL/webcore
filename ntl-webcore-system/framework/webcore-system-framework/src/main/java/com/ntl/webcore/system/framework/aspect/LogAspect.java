...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.ntl.webcore.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            operLog.setOperUrl(StrUtils.substring(ServletUtils.getRequest().getRequestURI(), 0, 255));
            if (currentUser != null)
            {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception
    {
        ...
        // 是否需要保存response，参数和值
        if (log.isSaveResponseData() && StrUtils.isNotNull(jsonResult))
        {
            operLog.setJsonResult(StrUtils.substring(JSONObject.toJSONString(jsonResult), 0, 2000));
        }
    }
