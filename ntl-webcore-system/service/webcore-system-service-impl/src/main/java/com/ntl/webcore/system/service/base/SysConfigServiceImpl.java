...
import com.ntl.webcore.common.web.utils.CacheUtils;
import com.ntl.webcore.system.common.model.entity.SysConfig;
import com.ntl.webcore.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public String selectConfigByKey(String configKey)
    {
        ...
        if (StrUtils.isNotNull(retConfig))
        {
    ...
    public void deleteConfigByIds(String ids)
    {
        ...
        for (Long configId : configIds)
        {
            ...
            if (StrUtils.equals(UserConstants.YES, config.getConfigType()))
            {
