package com.ntl.webcore.system.service.base;
...
import com.ntl.webcore.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public List<SysDictData> selectDictDataByType(String dictType)
    {
        ...
        if (StrUtils.isNotEmpty(dictDatas))
        {
            return dictDatas;
        }
    ...
    @Override
    public List<SysDictData> selectUserDictData(String dictType)
    {
        String loginUser = ShiroUtils.getLoginName();
        List<SysDictData> dictDatas = DictUtils.getDictCache(dictType+"_"+loginUser);
        if (StrUtils.isNotEmpty(dictDatas))
        {
            return dictDatas;
        }
        ...
        dictData.setCreateBy(loginUser);
        dictDatas = dictDataMapper.selectDictDataList(dictData);
        if (StrUtils.isNotEmpty(dictDatas))
        {
            DictUtils.setDictCache(dictType+"_"+loginUser, dictDatas);
            return dictDatas;
        }
        return null;
    }
    ...
    public List<Ztree> selectDictTree(SysDictType dictType)
    {
        ...
        {
            if (SysDictConstants.DICT_STATUS_NORMAL.equals(dict.getStatus()))
            {
