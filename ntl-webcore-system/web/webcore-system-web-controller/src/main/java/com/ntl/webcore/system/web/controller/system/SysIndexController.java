...
import com.ntl.webcore.common.web.utils.CookieUtils;
...
import com.ntl.webcore.system.common.model.entity.SysMenu;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", WebcoreConfig.getCopyrightYear());
        mmap.put("softName",WebcoreConfig.getSoftName());
        mmap.put("platformName",WebcoreConfig.getPlatformName());
        mmap.put("demoEnabled", WebcoreConfig.isDemoEnabled());
        ...
        {
            if (StrUtils.isNotEmpty(cookie.getName()) && "nav-style".equalsIgnoreCase(cookie.getName()))
            {
    ...
    {
        mmap.put("version", WebcoreConfig.getVersion());
        mmap.put("user", getSysUser());
        return "main";
    }
    ...
    public boolean passwordIsExpiration(Date pwdUpdateDate)
    {
        ...
        {
            if (StrUtils.isNull(pwdUpdateDate))
            {
                // 如果从未修改过初始密码，直接提醒过期
                return true;
            }
