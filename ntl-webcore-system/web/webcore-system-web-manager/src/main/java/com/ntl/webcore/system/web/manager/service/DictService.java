package com.ntl.webcore.system.web.manager.service;
...
public class DictService
{
    ...
    public List<SysDictData> getUserDictType(String dictTypeValue)
    {
        return dictTypeService.selectUserDictData(dictTypeValue);
    }
}
